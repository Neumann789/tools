...
public class IFICMPGECommand extends AbstractInstructionCommand {

	public IFICMPGECommand(Behaviour context) {
		super(context);
...

				{
					...
					while (infLoop.hasNext()) {
						...
						if (iloop.getStartIndex() == gotoIndex
							...
							// "+getJumpAddress(info,currentForIndex));
							// System.out.println(currentForIndex+"
							...
							// addBreak=checkForParentLoopForIF(ifst);
