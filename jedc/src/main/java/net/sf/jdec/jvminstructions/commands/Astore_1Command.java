...
public class Astore_1Command extends AbstractInstructionCommand {

	public Astore_1Command(Behaviour context) {
		super(context);
	...
	public void execute() {
		...
		if (add == true && !doNotPop) {
			...
			LocalVariable local = DecompilerHelper.getLocalVariable(1, "store",
