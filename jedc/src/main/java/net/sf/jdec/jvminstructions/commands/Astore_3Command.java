...
public class Astore_3Command extends AbstractInstructionCommand {

	public Astore_3Command(Behaviour context) {
		super(context);
	...
	public void execute() {
		...
		if (add == true && !doNotPop) {
			...
			LocalVariable local = DecompilerHelper.getLocalVariable(3, "store",
