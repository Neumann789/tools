...
/*
 *  Aload_2Command.java Copyright (c) 2006,07 Swaroop Belur
 *
 ...
 * @since 1.2.1
 */
public class Aload_2Command extends AbstractInstructionCommand{

    public Aload_2Command(Behaviour context) {
        super(context);
    }
    ...
    public void execute() {
        ...
        LocalVariable local= DecompilerHelper.getLocalVariable(2,"load","java.lang.Object",true,currentForIndex);
        if(local==null) {
