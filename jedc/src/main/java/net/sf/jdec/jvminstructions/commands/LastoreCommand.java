...
public class LastoreCommand extends AbstractInstructionCommand {

	public LastoreCommand(Behaviour context) {
		super(context);
	...
	public void execute() {
		...
		ArrayList skipPrimitiveArrayStores = GlobalVariableStore
				...
				if (arraytimesstack.size() == 0) {
					...
					if (curpos - 2 > 0
						...
						specialIASTORE = true;
							...
							&& info[curpos - 1] == JvmOpCodes.LADD
							&& info[curpos - 2] == JvmOpCodes.LCONST_1
